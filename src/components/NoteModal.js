...
export const NewNoteModal=()=>{
    ...
    <NoteModal note={null} handleFormSubbmit={NewNote} show={show} handleClose={handleClose}/>
...
export const EditNoteModal=({note})=>{
    ...
    <NoteModal note={note} handleFormSubbmit={EditNote} show={show} handleClose={handleClose}/>

    </div>
}


const NoteModal=({note,handleFormSubbmit, show,handleClose})=>{
...
useEffect(()=>{
    ...
    return (
        ...
        handleFormSubbmit(dispatch,modalNote);
             }}>
